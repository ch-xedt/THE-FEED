...
const SOURCES = [
    { label: 'Tagesschau',      tag: 'DE · INT',       url: 'https://www.tagesschau.de/xml/rss2/' },
    { label: 'ZDF',             tag: 'DE · INT',       url: 'https://www.zdf.de/rss/zdf/nachrichten' },
    { label: 'Deutsche Welle',  tag: 'DE · INT',       url: 'https://rss.dw.com/rdf/rss-de-all' },
    { label: 'Deutschlandfunk', tag: 'DE · INT',       url: 'https://www.deutschlandfunk.de/die-nachrichten.353.de.rss' },
    { label: 'BBC World',       tag: 'EN · INT',       url: 'https://feeds.bbci.co.uk/news/world/rss.xml' },
    { label: 'The Guardian',    tag: 'EN · INT',       url: 'https://www.theguardian.com/world/rss' },
    { label: 'NPR World',       tag: 'US · INT',       url: 'https://feeds.npr.org/1004/rss.xml' },
];
